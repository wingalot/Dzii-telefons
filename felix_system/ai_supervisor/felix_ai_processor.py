...
FORWARD_TO = YOUR_TELEGRAM_USER_ID  # Nigerian Prince Telegram ID
...
from felix_ai_supervisor import FixedFelixSupervisor

class SignalProcessor:
    """Processes queued signals with full AI"""
    
    def __init__(self):
        self.supervisor = FixedFelixSupervisor()
        self.client = None
    ...
    def process_signal(self, signal_data):
        ...
        # Process with fixed supervisor - expects full signal dict
        success = self.supervisor.process_single_signal(signal_data)
